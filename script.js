class Test {
  ...
  checkAnswer(i) {
      ...
      case 2:
          ...
          break;
      case 3:
          if (document.getElementById("pick31").checked && document.getElementById("pick32").checked && document.getElementById("pick33").checked && document.getElementById("pick34").checked ) {
              res = 1;
          }
          break;
      case 4:
      ...
      case 5:
          ...
          case 6:
            if (
              document.getElementById("Сontainer1").contains(document.getElementById("drag1")) &&
